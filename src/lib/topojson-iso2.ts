/**
 * Map TopoJSON numeric country IDs (ISO 3166-1 numeric) to ISO 3166-1 alpha-2
 * codes used throughout the Overcurrent pipeline.
 *
 * The world-110m.json atlas keys polygons by numeric code as a string
 * (e.g., Germany is "276"). All Overcurrent classification data uses alpha-2.
 */

const NUMERIC_TO_ISO2: Record<string, string> = {
  '004': 'AF', '008': 'AL', '012': 'DZ', '024': 'AO', '031': 'AZ',
  '032': 'AR', '036': 'AU', '040': 'AT', '044': 'BS', '048': 'BH',
  '050': 'BD', '051': 'AM', '052': 'BB', '056': 'BE', '064': 'BT',
  ...
  '-99': 'XK',  // Kosovo (sometimes -99 in TopoJSON)
}

export function numericIdToIso2(numericId: string | number): string | null {
