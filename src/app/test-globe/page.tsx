...
const MOCK_TIMELINE = [
  ...
  },
  {
    ...
    regions: [
      ...
      { region_id: "ir", status: "contradicted", coverage_volume: 50, dominant_quote: "US made excessive demands", outlet_count: 3, key_outlets: ["PressTV", "Fars News"] },
    ],
    flows: [
  ...
  },
  {
    ...
    regions: [
      ...
      { region_id: "ir", status: "contradicted", coverage_volume: 60, dominant_quote: "Iran victorious, US retreats", outlet_count: 5, key_outlets: ["PressTV", "Tasnim", "Fars"] },
  ...
  },
  {
    ...
    regions: [
      ...
      { region_id: "ir", status: "contradicted", coverage_volume: 70, dominant_quote: "US aggression proves bad faith", outlet_count: 6, key_outlets: ["PressTV", "Tasnim"] },
  ...
  },
  {
    ...
    regions: [
      ...
      { region_id: "ir", status: "contradicted", coverage_volume: 80, dominant_quote: "Iran stands firm against US bullying", outlet_count: 7, key_outlets: ["PressTV", "Tasnim"] },
